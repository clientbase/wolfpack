...
CBUFFER_START(UnityLighting)
	...
	#define unity_SHAr unityx_SHAr
    #define unity_SHAg unityx_SHAg
    #define unity_SHAb unityx_SHAb
    #define unity_SHBr unityx_SHBr
    #define unity_SHBg unityx_SHBg
    #define unity_SHBb unityx_SHBb
    #define unity_SHC unityx_SHC
	#else
    half4 unity_SHAr;
    half4 unity_SHAg;
    half4 unity_SHAb;
